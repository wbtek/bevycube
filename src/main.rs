...
// ==========================================
// 1. MAIN ENTRY & PLUGIN REGISTRATION
// ==========================================
...
fn main() {
    ...
    App::new()
        ...
        // MeshPickingPlugin is required for your Pointer observers
...
#[derive(Debug, Resource)] struct DiskParms { rotation_speed: f32 }
#[derive(Debug, Resource)] struct CubeParms { rotation_speed: f32 }
